/** Civic messages cycled under the progress bar while the emails go out. */
export const FOIA_MESSAGES = [
  ...
  'Instituțiile au 10 zile să răspundă, de la înregistrare. Ceasul deja ticăie.',
  'Sâmbăta, duminica și sărbătorile legale nu opresc termenul — doar îl împing dacă acolo cade ultima zi.',
...
export const FOIA_CYCLE_MS = 4000;
