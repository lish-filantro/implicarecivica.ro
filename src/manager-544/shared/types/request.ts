 ...
 *  - irelevant: not a Law 544 correspondence item (newsletter, signup confirmation, chit-chat)
 *  - redirectionat: the institution forwarded the request to a competent institution
 */
...
export interface Request {
  ...
  // Institution the request was redirected to (category 'redirectionat')
