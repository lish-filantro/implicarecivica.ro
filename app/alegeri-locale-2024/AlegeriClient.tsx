...
interface AlegeriClientProps {
  summary: SummaryData;
  primariData: ResultEntry[];
  consiliuLocalData: ResultEntry[];
}

/* ─── Main Client Component ────────────────────────────────────── */

export default function AlegeriClient({ summary, primariData, consiliuLocalData }: AlegeriClientProps) {
  ...
  const currentData: ResultEntry[] = useMemo(() => {
    if (activeTab === "primari") return primariData;
    if (activeTab === "consiliu_local") return consiliuLocalData;
    return [];
  }, [activeTab, primariData, consiliuLocalData]);
