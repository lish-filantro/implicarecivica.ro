  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-8">
        ...
        <a href="/campanii/admin/campanii/new" className="btn-activist flex items-center gap-2">
      ...
      {campaigns.length === 0 ? (
        <div className="text-center py-16 border-2 border-dashed border-urban-gray-300">
          ...
          <a href="/campanii/admin/campanii/new" className="btn-activist inline-flex items-center gap-2">
                ...
                <tr key={c.id} className="border-b hover:bg-urban-gray-50 transition-colors">
                  <td className="py-3">
                    <div>
                      ...
                      <p className="text-xs text-urban-gray-400 font-mono">/campanii/{c.slug}</p>
                    </div>
                  </td>
