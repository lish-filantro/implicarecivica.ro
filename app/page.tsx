    ...
    <div className="min-h-screen bg-white">
      ...
      <nav className="fixed top-0 w-full bg-white/80 backdrop-blur-sm border-b border-gray-100 z-50">
        <div className="max-w-5xl mx-auto px-6 h-14 flex items-center justify-between">
          <span className="font-activist text-lg tracking-tight text-civic-blue-700">
            implicarecivica.ro
          </span>
          <div className="flex items-center gap-3">
            <Link
              href="/login"
              className="text-sm text-gray-600 hover:text-civic-blue-600 transition-colors"
            >
              Autentificare
            </Link>
            <Link
      ...
      <section className="pt-32 pb-20 px-6">
        <div className="max-w-3xl mx-auto text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 leading-tight tracking-tight">
            ...
            <br />
            <span className="text-civic-blue-500">Noi te ajutăm să o ceri.</span>
          </h1>
      ...
      <section id="problema" className="py-20 px-6 bg-gray-50">
        <div className="max-w-2xl mx-auto">
          <h2 className="text-sm font-semibold uppercase tracking-wider text-civic-blue-500 mb-4">
            Problema
          </h2>
      ...
      <section className="py-20 px-6">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-sm font-semibold uppercase tracking-wider text-civic-blue-500 mb-10 text-center">
            Ce facem
          </h2>
          <div className="grid md:grid-cols-2 gap-8">
            {/* Card 1 */}
            <div className="p-8 rounded-xl border border-gray-200 hover:border-civic-blue-200 hover:shadow-md transition-all">
              <div className="w-12 h-12 rounded-lg bg-civic-blue-50 flex items-center justify-center mb-5">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="w-6 h-6 text-civic-blue-500">
      ...
      <section className="py-20 px-6 bg-gray-50">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-sm font-semibold uppercase tracking-wider text-civic-blue-500 mb-12 text-center">
            Cum funcționează
          </h2>
      ...
      <section className="py-20 px-6">
        <div className="max-w-2xl mx-auto text-center">
          <h2 className="text-sm font-semibold uppercase tracking-wider text-civic-blue-500 mb-6">
            De ce contează
          </h2>
          <p className="text-xl text-gray-700 leading-relaxed">
      ...
      {/* ─── CTA final ─── */}
      <section className="py-24 px-6 bg-civic-blue-500">
        <div className="max-w-2xl mx-auto text-center">
      ...
      <footer className="py-10 px-6 border-t border-gray-100">
        <div className="max-w-4xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-gray-400">
          <div className="flex items-center gap-6">
            <span className="font-activist text-gray-500 tracking-tight">implicarecivica.ro</span>
            <a href="mailto:contact@implicarecivica.ro" className="hover:text-gray-600 transition-colors">
