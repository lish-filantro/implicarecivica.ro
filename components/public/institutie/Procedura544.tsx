...
/**
 * Contactele instituţiilor sunt ascunse momentan. Datele sunt incomplete: din 86 de intrări,
 * 44 sunt şabloane per judeţ/localitate şi niciunul nu are o adresă, iar o adresă greşită pe o
 * pagină publică face mai mult rău decât lipsa ei. Adresa corectă o găseşte asistentul, verificată
 * online, în fluxul unei cereri. Reactivarea: `true` aici, după ce lista e verificată.
 */
export const AFISEAZA_CONTACTE = false

/**
 * Sidebar card "Trimite o cerere 544": the CTA into the app (`/requests/start`, where the user
 * picks the manual form or the assistant; middleware sends anonymous visitors to login) and,
 * when enabled, the department, email, phone and address for Law 544 requests.
 */
export function Procedura544({
  inst,
  afiseazaContacte = AFISEAZA_CONTACTE,
}: {
  inst: Institutie
  afiseazaContacte?: boolean
}) {
