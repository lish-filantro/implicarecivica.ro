/**
 * RequestCard - VARIANTA 2: Bare Colorate Accent
 * Folosește bare verticale colorate în loc de iconuri mari
 */
...
export function RequestCard({ request, onClick, isSelected = false }: RequestCardProps) {
  ...
  return (
    ...
    >
      ...
      {/* BODY */}
      <div className="flex relative" style={{ minHeight: '140px' }}>

        {/* LEFT: Question */}
        <div className={`flex ${hasAnswer ? 'w-1/2' : 'flex-1'} relative`}>
          {/* Bară accent violet */}
          <div className="w-1 bg-gradient-to-b from-violet-500 to-purple-600 shrink-0" />

          <div className="flex-1 p-5 bg-gradient-to-r from-violet-50/50 to-transparent dark:from-violet-900/10 dark:to-transparent">
        ...
        {hasAnswer ? (
          <div className="flex w-1/2 relative">
            ...
            <div className="flex-1 flex flex-col p-5 bg-gradient-to-r from-emerald-50/50 to-transparent dark:from-emerald-900/10 dark:to-transparent rounded-br-xl">
              <div className="flex items-center gap-2 mb-3">
